...
export default function VerifyEmail() {
  ...
  useEffect(() => {
    const verify = async () => {
      ...
      // Simulate API call — when backend is ready,
      // replace this with: await authAPI.verifyEmail(token)
      await new Promise((r) => setTimeout(r, 1500));

      // Mock: any token that is 10+ chars is considered valid
      if (token.length >= 10) {
        verifyEmail();
        addNotification({
          type: 'welcome',
  ...
  return (
    <div className="min-h-screen flex items-center justify-center px-4 relative overflow-hidden">
      ...
      >
        {/* Logo */}
        <Link to="/" className="font-sora font-extrabold text-xl inline-block mb-8">
        ...
        {status === 'verifying' && (
          ...
          >
            ...
            <h1 className="font-sora font-bold text-xl">Verifying your email...</h1>
